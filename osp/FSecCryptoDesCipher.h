 ...
 */
#ifndef _FSEC_CRYPTO_DES_CIPHER_H_
#define _FSEC_CRYPTO_DES_CIPHER_H_
...
private:
	...
	// @since 2.0
	//
	DesCipher& operator =(const DesCipher& rhs);
...
private:
	...
	class _DesCipherImpl* __pDesCipherImpl;
	friend class _DesCipherImpl;

}; //DesCipher

} } } //Tizen::Security::Crypto

#endif //_FSEC_CRYPTO_DES_CIPHER_H_
