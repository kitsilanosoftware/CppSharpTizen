 ...
 */
#ifndef _FSEC_CRYPTO_SHA1_HMAC_H_
#define _FSEC_CRYPTO_SHA1_HMAC_H_
...
private:
	...
	// @since 2.0
	//
	Sha1Hmac& operator =(const Sha1Hmac& rhs);

private:
	hmac_ctx_st* __pSha1HmacCtx;
	Tizen::Base::ByteBuffer __keyBytes;

	class _Sha1HmacImpl* __pSha1HmacImpl;
	friend class _Sha1HmacImpl;

}; //Sha1Hmac

} } } //Tizen::Security::Crypto

#endif //_FSEC_CRYPTO_SHA1_HMAC_H_
