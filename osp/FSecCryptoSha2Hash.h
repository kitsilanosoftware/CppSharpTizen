 ...
 */
#ifndef _FSEC_CRYPTO_SHA2_HASH_H_
#define _FSEC_CRYPTO_SHA2_HASH_H_
 ...
 *	@see		Tizen::Security::Crypto::Sha1Hash
 */
class _OSP_EXPORT_ Sha2Hash
...
private:
	...
	// @since 2.0
	//
	Sha2Hash& operator =(const Sha2Hash& rhs);

private:
	const env_md_st* __pAlgorithm;
	env_md_ctx_st* __pEvpMdCtx;

	class _Sha2HashImpl* __pSha2HashImpl;
	friend class _Sha2HashImpl;

}; //Sha2Hash

} } } //Tizen::Security:Crypto

#endif //_FSEC_CRYPTO_SHA2_HASH_H_
