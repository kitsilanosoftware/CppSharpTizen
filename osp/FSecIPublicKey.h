 ...
 * @since		2.0
 *
 * The %IPublicKey interface provides the functionality shared by all the public key instances. @n
 *
...
protected:
	...
	// @since 2.0
	//
	virtual void IPublicKey_Reserved1(void) {}
