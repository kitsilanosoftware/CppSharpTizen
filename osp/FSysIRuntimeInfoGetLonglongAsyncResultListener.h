...
/**
* @file FSysIRuntimeInfoGetLonglongAsyncResultListener.h
* @brief          This is the header file for the %IRuntimeInfoGetLonglongAsyncResultListener interface.
*
* This header file contains the declarations of the %IRuntimeInfoGetLonglongAsyncResultListener interface.
*/
 
#ifndef _FSYS_IRUNTIME_INFO_GET_LONGLONG_ASYNC_RESULT_LISTENER_H_
#define _FSYS_IRUNTIME_INFO_GET_LONGLONG_ASYNC_RESULT_LISTENER_H_
...
public:
           ...
           * @since 2.0
           */
           virtual ~ IRuntimeInfoGetLonglongAsyncResultListener (void) {}
           /**
           * Called when a result received from an asynchronous method call is a key of type @c long @c long.
           *
           * @since 2.0
           *
...
#endif // _FSYS_IRUNTIME_INFO_GET_LONGLONG_ASYNC_RESULT_LISTENER_H_
