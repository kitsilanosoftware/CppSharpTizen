...
* The class is registered with a %SectionTableView, using the SectionTableView::SetItemProvider() method.
*/
...
public:
	...
	*/
	...
	/**
	* Gets the total number of items in the specified section.
	*
	* @since 2.0
	*
