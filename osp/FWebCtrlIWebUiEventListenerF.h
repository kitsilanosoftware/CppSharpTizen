...
/**
* @file            FWebCtrlIWebUiEventListenerF.h
* @brief                     This is the header file for the %IWebUiEventListenerF interface.
*
* This header file contains the declarations of the %IWebUiEventListenerF interface.
*/
#ifndef _FWEB_CTRL_IWEB_UI_EVENT_LISTENER_F_H_
#define _FWEB_CTRL_IWEB_UI_EVENT_LISTENER_F_H_
...
public:
	 ...
	 * @since		2.1
	 */
	virtual ~IWebUiEventListenerF (void) {}
	 ...
	 */
	virtual void OnWebPageBlockSelected(Tizen::Web::Controls::Web& source, Tizen::Graphics::FloatPoint& startPoint, Tizen::Graphics::FloatPoint& endPoint) = 0;
...
protected:
	...
	// @since		2.1
	//
	virtual void IWebUiEventListenerF_Reserved1(void) {};
	...
	// @since		2.1
	//
	virtual void IWebUiEventListenerF_Reserved2(void) {};
	...
	// @since		2.1
	//
	virtual void IWebUiEventListenerF_Reserved3(void) {};
	...
	// @since		2.1
	//
	virtual void IWebUiEventListenerF_Reserved4(void) {};
}; // IWebUiEventListenerF

}}} // Tizen::Web::Controls
#endif // _FWEB_CTRL_IWEB_UI_EVENT_LISTENER_F_H_
