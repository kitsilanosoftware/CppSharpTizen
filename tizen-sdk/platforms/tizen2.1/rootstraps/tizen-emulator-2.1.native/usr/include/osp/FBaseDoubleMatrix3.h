...
/**
 * @file	FBaseDoubleMatrix3.h
 * @brief	This is the header file for the %DoubleMatrix3 class.
 *
...
public:
	 ...
	 * @since 2.0
	 *
	 * @param[in]	matrix	The matrix with 9 @c double values
	 */
	DoubleMatrix3(const double matrix[3][3]);
	 ...
	 * @since 2.0
	 */
	virtual ~DoubleMatrix3(void);

	/**
	 * Checks whether the current instance and the specified instance of %DoubleMatrix3 are equal.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * Checks whether the current instance and the specified instance of %DoubleMatrix3 are not equal.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * Assigns the value of the specified instance to the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	 * @return	The reference to this instance
	...
	/**
	 * Subtracts the value of the specified instance and the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	 * @return	A new instance of %DoubleMatrix3 containing the resulting value of the operation
	...
	/**
	 * Subtracts the value of the specified instance from the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	 * @return	The reference to %DoubleMatrix3 containing the resulting value of the operation
	...
	/**
	 * Checks whether the current instance of %DoubleMatrix3 equals the specified instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * Gets the hash value of the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * Gets the determinant of the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * Gets the inverse matrix of the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	 * @return	A new instance of %DoubleMatrix3 containing the resulting value of the operation
	...
	/**
	 * Gets the trace of the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * Gets the transpose matrix of the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	 * @return	A new instance of %DoubleMatrix3 containing the resulting value of the operation
	...
	/**
	 * Sets the identity matrix to the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 */
	...
	/**
	 * Sets the inverse matrix to the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * The matrix of the current instance of %DoubleMatrix3.
	 *
	 * @since 2.0
	 *
...
private:
	friend class _DoubleMatrix3Impl;
