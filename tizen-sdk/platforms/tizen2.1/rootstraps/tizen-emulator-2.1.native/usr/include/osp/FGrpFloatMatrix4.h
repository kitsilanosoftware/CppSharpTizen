...
#ifndef _FGRP_FLOAT_MATRIX4_H_
#define _FGRP_FLOAT_MATRIX4_H_
 ...
 * @since 2.0
 *
 * The %FloatMatrix4 class provides a float precision, two-dimensional matrix class.
 *
 */
...
public:
	 ...
	 * This constructor initializes a 4 X 4 identity matrix.
	 *
	 * @since 2.0
	 */
	FloatMatrix4(void);
	...
	/**
	 * This is the copy constructor for the %FloatMatrix4 class. @n
	 * This constructor initializes the instance of %FloatMatrix4 with the attributes of the specified instance of %FloatMatrix4.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * This constructor initializes the instance of %FloatMatrix4 with the attributes of the specified instance of the array.
	 *
	 * @since 2.0
	 *
	 * @param[in]	matrix	The matrix with 16 float values
	 */
	...
	/**
	 * Assigns the values of the specified instance to the current instance of %FloatMatrix4.
	 *
	 * @since 2.0
	 *
	...
	/**
	 * Multiplies the current instance of %FloatMatrix4 with %FloatVector4.
	 *
	 * @since 2.0
	 *
