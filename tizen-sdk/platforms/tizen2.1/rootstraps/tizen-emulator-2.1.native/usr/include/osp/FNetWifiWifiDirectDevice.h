...
public:
	 ...
	 * @remarks     Some devices may not support to activate Wi-Fi Direct™ during Wi-Fi on,
	 ...
	 *                configuration information, this group configuration information is valid until the group is
	 *                destroyed.If @c pWifiDirectGroupInfo is not specified, the Wi-Fi Direct group is created as per
	 ...
	 * @endif
	 */
	result CreateGroup(const WifiDirectGroupInfo* pWifiDirectGroupInfo = null,
			const WifiDirectDeviceInfo* pWifiDirectRemoteDeviceInfo = null);
	 ...
	 *                sent to the remote device and the configured group information is used at this time.
	 ...
	 *
	 * @remarks     If the member type of the local device is not a group owner or client, the channel does not contain
	 *              valid information.
	 */
