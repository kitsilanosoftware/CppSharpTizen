...
/**
 * @file	FUiAnimExpInTimingFunction.h
 * @brief	This is the header file for the %ExpInTimingFunction class.
 *
 * This header file contains the declarations of the %ExpInTimingFunction class.
 */

#ifndef _FUI_ANIM_EXP_IN_TIMING_FUNCTION_H_
#define _FUI_ANIM_EXP_IN_TIMING_FUNCTION_H_
...
/**
 * @class	ExpInTimingFunction
 * @brief	This class stores the information of an exp-in timing function.
 *
 * @since	2.0
 *
 * The %ExpInTimingFunction class provides exp-in timing function related information.
 *
 ...
 *
 */
class _OSP_EXPORT_ ExpInTimingFunction
...
public:
	 ...
	 * @since	2.0
	 */
	virtual ~ExpInTimingFunction(void);
...
private:
	...
	// @since  2.0
	//
	ExpInTimingFunction(const ExpInTimingFunction& rhs);
	...
	// and consistency-related issues in the application.
	//
	// Assigns the value of the specified instance to the current instance of %ExpInTimingFunction.
	//
	// @since  2.0
	//
	ExpInTimingFunction& operator =(const ExpInTimingFunction& rhs);
...
#endif //_FUI_ANIM_EXP_IN_TIMING_FUNCTION_H_
