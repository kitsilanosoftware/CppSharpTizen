 ...
 * @since	2.0
 *
 * The %AnimationFrame class defines the common behavior of an %AnimationFrame control. @n
...
public:
	...
	/**
	 * Initializes this instance of %AnimationFrame with the specified image and duration.
	 *
	 * @since		2.0
	 *
