 ...
 * @brief	This class positions the children of a container in a manner that is relative to other children or its parent container.
 *
 * @since	2.0
 *
 ...
 *
 * The following examples demonstrate how to use the %RelativeLayout class.
 * @code
...
public:
	 ...
	 * @return		An error code
	 * @param[in]	childControl	The control for which the relation is set
	 * @param[in]	pTargetControl	The target control @n
	 *								It must be a parent or sibling.
	 * @param[in]	edgeRelation	The edge of the specified control to align with the edge of the target control
	 * @exception	E_SUCCESS		The method is successful.
