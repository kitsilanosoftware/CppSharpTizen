...
/**
 * @defgroup	opengles_1_1 OpenGL&reg; ES 1.1
 * @brief	The list of OpenGL&reg;ES 1.1 functions.
 * @{
 */
...
/**
 * You can find more details at the Khronos Group site: <a href="#" onClick="window.open('http://www.khronos.org/opengles/sdk/1.1/docs/man')" target="_blank">Khronos Group site - OpenGL&reg; ES 1.1</a>.
 *
 * @since 2.0
